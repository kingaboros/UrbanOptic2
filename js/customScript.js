...
//           (!targetSection || sectionStart < targetSection.offsetLeft)) ||
//         (delta < 0 &&
//           sectionEnd < currentScrollLeft &&
//           (!targetSection || sectionEnd > targetSection.offsetLeft))
//       ) {
//         targetSection = section;
//       }
//     });
...
//         const distance =
//           delta > 0
//             ? targetPosition - mainContainer.scrollLeft
//             : mainContainer.scrollLeft - targetPosition;

//         // Check if the scroll step will overshoot the target position
//         if (
//           (delta > 0 &&
//             mainContainer.scrollLeft + scrollSpeed >= targetPosition) ||
//           (delta < 0 &&
//             mainContainer.scrollLeft - scrollSpeed <= targetPosition)
//         ) {
//           mainContainer.scrollLeft = targetPosition;
...
//           });
//         } else {
//           mainContainer.scrollLeft += delta > 0 ? scrollSpeed : -scrollSpeed;
//         }
//       }, 5); // Adjust the scroll interval speed as needed (in milliseconds)
//     }
